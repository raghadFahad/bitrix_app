<?php
define('C_REST_CLIENT_ID','local.603bc67c28d421.51799133');//Application ID
define('C_REST_CLIENT_SECRET','6vmHZcqAVSH2a9GsHh49OPlYXK3o74ax5fHuFEOP5DlvwiuU4c');//Application key
// or
