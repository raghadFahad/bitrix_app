<?php
define('C_REST_CLIENT_ID','local.603b71ed456988.59925193');//Application ID
define('C_REST_CLIENT_SECRET','oayqqdowPxBYIC4MdkhAqEFQ5R4MhuWL0xLf9GFEoQYqh0U5J2');//Application key
// or
